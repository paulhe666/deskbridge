...
path remains a beta feature. Version 1.1.3 uses one shared pointer transition
...
1. Download `Deskbridge-Setup-1.1.3.exe`.
...
1. Download `Deskbridge-1.1.3.pkg`.
...
Windows 边缘投递条。macOS 作为服务端目前仍属于 Beta 功能。v1.1.3 已让
...
1. 下载 `Deskbridge-Setup-1.1.3.exe`。
2. 双击安装包并按安装向导安装。
